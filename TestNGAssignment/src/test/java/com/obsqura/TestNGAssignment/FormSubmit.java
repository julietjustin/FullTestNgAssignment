...
public class FormSubmit extends BaseFormSubmitPage {
	...
	public void ClickFormSubmitLink() {
		driver.findElement(By.xpath("(//div[@class='card-header'])[2]")).click();
	...
	public void checkingField(){
		...
		Assert.assertEquals(outputMessage, inputMessage, "The message is not correct");
	}
	/*@Test(description="Enter data in all fields and donot select the checkbox")
	public void checkBoxNotClicked(){
		String inputMessage1="Agree to terms and conditions",outputMessage;
		boolean buttonEnable;
		boolean flag=false;
		driver.findElement(By.xpath("(//input[@class='form-control'])[1]")).sendKeys("Juliet");
		driver.findElement(By.xpath("(//input[@class='form-control'])[2]")).sendKeys("Justin");
		driver.findElement(By.xpath("(//input[@class='form-control'])[3]")).sendKeys("julietjustin");
		driver.findElement(By.xpath("(//input[@class='form-control'])[4]")).sendKeys("Alappuzha");
		driver.findElement(By.xpath("(//input[@class='form-control'])[5]")).sendKeys("Kerala");
		driver.findElement(By.xpath("(//input[@class='form-control'])[6]")).sendKeys("688505");
		buttonEnable=driver.findElement(By.xpath("//button[@class='btn btn-primary']")).isEnabled();
		if(buttonEnable==true) {
			flag=true;
		}
		...
		driver.findElement(By.xpath("//button[@class='btn btn-primary']")).click();
		outputMessage=driver.findElement(By.xpath("//div[@id='message-one']")).getText();
		Assert.assertEquals(outputMessage, inputMessage1, "The message is not correct");
	}*/
	...
	public void buttonBackgroundColour(){
		...
		Assert.assertEquals(backGroundColour, inputBackColour, "Colour Not Matching");
	}
	...
	public void buttonTextColour() {
		...
		Assert.assertEquals(textColour, inputColour, "The Colours are not matching");
